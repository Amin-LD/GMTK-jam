...
[AddComponentMenu("Camera-Control/FPSCam")]
public class FPSCam : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        parentRotation = transform.parent.transform.localRotation;
    }
    ...
    private void CameraRotation()
    {
        if (axes == RotationAxes.MouseXAndY)
        {
            ...
            transform.parent.transform.localRotation = parentRotation * xQuaternion;
        }
